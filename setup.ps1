...
<head>
    ...
    <meta name=`"description`" content=`"Iron & Soul Gym - Premium Fitness Experience`">
    <title>Iron & Soul Gym</title>
    <!-- Google Fonts will be imported in CSS -->
...
foreach ($theme in $themes) {
    ...
    Set-Content -Path (Join-Path $themeDir "script.js") -Value $jsContent -Encoding UTF8
    Set-Content -Path (Join-Path $themeDir "style.css") -Value "/* Styles for $theme */" -Encoding UTF8
}

Write-Output "Initial structure created successfully."
